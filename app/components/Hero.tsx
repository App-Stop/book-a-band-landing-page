  ...
  return (
    <section id="home" className="relative w-full text-white">
      ...
      <div className="@container relative z-10 mx-auto flex w-full max-w-[1920px] flex-col gap-6 px-5 pb-10 pt-[88px] sm:px-8 sm:pt-[104px] lg:block lg:aspect-[1920/986] lg:gap-0 lg:p-0">
        ...
        <p className="max-w-[441px] text-base leading-[26px] tracking-[0.4px] lg:max-w-[24cqw] lg:tracking-[0.3px] [text-shadow:0px_0px_30px_rgba(0,0,0,0.8)] sm:text-lg lg:absolute lg:left-[7.29%] lg:top-[41.9%] lg:text-[max(16px,1.04cqw)] lg:leading-[1.5]">
        ...
        <div className="relative mx-auto aspect-[1191/1708] w-full max-w-[300px] sm:max-w-[380px] lg:absolute lg:left-[58.8%] lg:top-[5.9%] lg:mx-0 lg:w-[31.15%] lg:max-w-none">
          <Image
            src="/phones.png"
