  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative z-10 flex w-full max-w-[900px] flex-col items-center gap-8 overflow-hidden rounded-[32px] bg-[#23213c] px-5 pb-8 pt-8 text-white shadow-[0px_4px_160px_rgba(0,0,0,0.6)] sm:gap-10 sm:rounded-[40px] sm:px-8 sm:pb-10 sm:pt-9 lg:gap-[60px] lg:rounded-[50px] lg:px-[30px] lg:pb-[80px] lg:pt-[30px]"
      >
        ...
        <div className="relative z-10 flex w-full flex-col items-end gap-2.5">
          ...
          <div className="flex w-full flex-col items-center gap-2 text-center sm:gap-3 lg:gap-4">
            <h2
              id="get-app-title"
              className="display text-[clamp(24px,4.5vw,48px)] uppercase leading-none"
            >
              Scan to download
            </h2>
            <p className="mx-auto max-w-[540px] text-[15px] leading-6 tracking-[0.4px] text-white text-shadow-[0px_0px_30px_rgba(0,0,0,0.8)] sm:text-base lg:text-xl lg:leading-[30px]">
              Point your smartphone camera at the QR to download Book a Band
            </p>
          </div>
        </div>

        <div className="relative z-10 flex flex-col items-center gap-8 sm:flex-row sm:items-center sm:justify-center sm:gap-12 lg:gap-[100px]">
          <div className="flex flex-col items-center gap-4 sm:gap-6 lg:gap-[40px]">
            <Image
              src="/qr.png"
              ...
              height={342}
              priority
              className="size-[180px] rounded-[26px] bg-white object-cover sm:size-[240px] sm:rounded-[34px] lg:size-[342px] lg:rounded-[50px]"
            />
              ...
              {storeLinks.map(({ src, alt, href }) => (
                ...
                >
                  <Image
                    ...
                    width={162}
                    height={60}
                    className="h-[38px] w-[103px] object-contain sm:h-[46px] sm:w-[125px] lg:h-[60px] lg:w-[163px]"
                  />
                </a>
              ))}
            </div>
          ...
          <div
            aria-hidden="true"
            className="w-[110px] shrink-0 overflow-hidden rounded-[10%] bg-[length:181.75%_auto] bg-center bg-no-repeat sm:w-[150px] lg:w-[210px]"
            style={{
